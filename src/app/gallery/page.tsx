...
export default function GalleryPage() {
  ...
  "/media/forresterfields/FB_IMG_1760901027010(1).jpg",
  "/media/forresterfields/FB_IMG_1760901028874.jpg",
  "/media/forresterfields/FB_IMG_1760901032241.jpg",
  "/media/forresterfields/FB_IMG_1760901032241(1).jpg",
  "/media/forresterfields/FB_IMG_1760901040620.jpg",
  "/media/forresterfields/IMG-20251019-WA0001.jpg",
  ...
  "/media/forresterfields/qt=q_4.jpeg",
  ...
  "/media/forresterfields/rs=w_806,h_537(1).jpeg",
  "/media/forresterfields/rs=w_806,h_540.jpeg",
  "/media/forresterfields/rs=w_806,h_605 (1).jpeg",
            ...
            {FILES.map((src, i) => (
              ...
              >
                <Image
                  ...
                  priority={i < 4}
                />
                <div className="pointer-events-none absolute inset-0 rounded-xl shadow-[inset_0_0_0_1px_rgba(0,0,0,0.04)]" />
              </button>
            ))}
          </div>
        </div>
