  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute top-10 right-[-5rem] h-64 w-64 rounded-full bg-amber-100 opacity-50" />
      ...
      <section className="container py-12 flex justify-center">
        <div className="w-full max-w-2xl rounded-2xl border border-white/70 bg-white shadow-xl">
          <header className="rounded-t-2xl border-b border-white/70 bg-gradient-to-r from-pink-50 via-rose-50 to-amber-50 px-6 py-8 text-center">
